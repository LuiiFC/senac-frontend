...
const styles = {
  ...
  card: { background: '#fff', borderRadius: 12, padding: 20, boxShadow: '0 2px 8px rgba(0,0,0,0.06)', borderLeft: '4px solid #C8102E' },
  cardNome: { fontWeight: 700, fontSize: 16, color: '#1A1A1A', margin: '0 0 4px' },
  cardCurso: { color: '#C8102E', fontSize: 13, fontWeight: 600, margin: '0 0 8px' },
