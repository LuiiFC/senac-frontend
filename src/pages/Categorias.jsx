...
const styles = {
  ...
  pastaDestaque: { border: '2px solid #C8102E', boxShadow: '0 4px 16px rgba(200,16,46,0.15)' },
  ...
  dropHint: { background: '#FFF5F5', color: '#C8102E', textAlign: 'center', padding: '8px', fontSize: 13, fontWeight: 600 },
